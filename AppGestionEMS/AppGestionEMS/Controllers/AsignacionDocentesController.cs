...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,CreditosAsignados")] AsignacionDocentes asignacionDocentes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CursoId,CreditosAsignados")] AsignacionDocentes asignacionDocentes)
        {
            if (ModelState.IsValid)
            {
